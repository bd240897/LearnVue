...
PATH_MODEL = os.path.join(BASE_DIR_TEMP, APP_NAME_TEMP, "ml_static", "model_weights.pth")
PATH_LABEL_ENCODER = os.path.join(BASE_DIR_TEMP, APP_NAME_TEMP, "ml_static", "label_encoder.pkl")
PATH_LABELS_LIST = os.path.join(BASE_DIR_TEMP, APP_NAME_TEMP, "ml_static", "labels.json")
...
PATH_IMG_FILE = os.path.join(BASE_DIR_TEMP, APP_NAME_TEMP, "ml_static", "data", "agnes_skinner", "pic_0000.jpg")
...
if __name__ == '__main__':
    ...
    # TODO work only jpg files
    user_file = r"C:\Users\Дмитрий\WebstormProjects\LearnVue\api\media\third_img.jpg"
    user_file = r"C:\Users\Дмитрий\WebstormProjects\LearnVue\api\media\learnVue\post_image\borisov_2.JPG"
    y_pred = make_prediction(file=user_file)
    print(y_pred)
